...
function Lo(t2) {
  ...
  if ((e2 = (_a2 = pn(t2, is, 4)) == null ? void 0 : _a2.h()) && (s2.boundingBox = { originX: An(e2, 1) ?? 0, originY: An(e2, 2) ?? 0, width: An(e2, 3) ?? 0, height: An(e2, 4) ?? 0, angle: 0 }), (_b = pn(t2, is, 4)) == null ? void 0 : _b.g().length) for (const e3 of pn(t2, is, 4).g()) s2.keypoints.push({ x: Ze(e3, 1) ?? 0, y: Ze(e3, 2) ?? 0, score: Ze(e3, 4) ?? 0, label: re(ze(e3, 3)) ?? "" });
  return s2;
}
function Ro(t2) {
  const e2 = [];
...
var yh = class extends Za {
  ...
  o(t2) {
    ...
    if (xn(this.v, 3, t2.numHands ?? 1), "minHandDetectionConfidence" in t2 && Ln(this.v, 2, t2.minHandDetectionConfidence ?? 0.5), "minTrackingConfidence" in t2 && Ln(this.s, 4, t2.minTrackingConfidence ?? 0.5), "minHandPresenceConfidence" in t2 && Ln(this.C, 2, t2.minHandPresenceConfidence ?? 0.5), t2.cannedGesturesClassifierOptions) {
      var e2 = new Hs(), n2 = e2, r2 = So(t2.cannedGesturesClassifierOptions, (_a2 = pn(this.h, Hs, 3)) == null ? void 0 : _a2.h());
      yn(n2, 0, 2, r2), yn(this.h, 0, 3, e2);
    } else void 0 === t2.cannedGesturesClassifierOptions && ((_b = pn(this.h, Hs, 3)) == null ? void 0 : _b.g());
    return t2.customGesturesClassifierOptions ? (yn(n2 = e2 = new Hs(), 0, 2, r2 = So(t2.customGesturesClassifierOptions, (_c = pn(this.h, Hs, 4)) == null ? void 0 : _c.h())), yn(this.h, 0, 4, e2)) : void 0 === t2.customGesturesClassifierOptions && ((_d = pn(this.h, Hs, 4)) == null ? void 0 : _d.g()), this.l(t2);
  }
  Ma(t2, e2) {
    ...
    Bi(n2, "mediapipe.tasks.vision.image_classifier.ImageClassifierGraph"), Gi(n2, "IMAGE:input_image"), Gi(n2, "NORM_RECT:norm_rect"), ji(n2, "CLASSIFICATIONS:classifications"), n2.o(e2), zi(t2, n2), this.g.attachProtoListener("classifications", ((t3, e3) => {
      this.j = (function(t4) {
        const e4 = { classifications: mn(t4, ds, 1).map(((t5) => {
          var _a2;
          return xo(((_a2 = pn(t5, Qi, 4)) == null ? void 0 : _a2.g()) ?? [], Tn(An(t5, 2), 0), kn(t5, 3));
        })) };
      ...
      t3 = vs(t3), this.embeddings = (function(t4) {
        return { embeddings: mn(t4, ys, 1).map(((t5) => {
          ...
          if (void 0 !== dn(t5, gs, hn(t5, 1))) t5 = en(t5 = pn(t5, gs, hn(t5, 1)), 1, Ht, tn()), e4.floatEmbedding = t5.slice();
            ...
            e4.quantizedEmbedding = ((_b = (_a2 = pn(t5, ms, hn(t5, 2))) == null ? void 0 : _a2.ra()) == null ? void 0 : _b.ua()) ?? n3;
          }
          return e4;
...
var Fh = class extends Za {
  ...
  J() {
    !(function(t2) {
      ...
      1 === e2.length && (((_b = (_a2 = pn(e2[0], Ci, 7)) == null ? void 0 : _a2.l()) == null ? void 0 : _b.g()) ?? /* @__PURE__ */ new Map()).forEach(((e3, n2) => {
...
//# sourceMappingURL=vision_bundle-EXBAMLEA.js.map
